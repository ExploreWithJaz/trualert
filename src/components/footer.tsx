  ...
  return (
    <div className='px-20'>
        <div className='mx-[232.5px] pb-20'>
            <div className='px-8 py-10 bg-[#292929] rounded-[10px]'>
