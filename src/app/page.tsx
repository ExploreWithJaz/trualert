    ...
    <>
      ...
      <div className='mt-20 px-2'>
        <section className='flex flex-col items-center max-w-[850px] mx-auto py-2.5 gap-5 text-center'>
          <div className='text-[80px]/23 font-bold w-full'>
            <h1>
              EMERGENCY AID, JUST A <span className='text-[#ff0f0f]'>TAP AWAY</span>
            </h1>
          </div>
          <div className='text-lg w-[588.8px] h-auto mb-3.5 '>
          ...
          <div className='flex justify-center items-center gap-4'>
            ...
            <img className='w-[125px]' src="/google-play-button.svg" alt="Google Play Download Button" />
          </div>
          <div>
            <a href="">
